    ...
    <div  >
      <div className='bg-black w-screen h-[70px] flex justify-between  '>
        ...
        <ul className='flex text-white mr-20 mt-5 gap-6 text-xl'>
          ...
          {
            isAuthenticated ? <li ><button  style={{ backgroundColor: "#FFD700", color: "black", height: "30px", width: "90px", borderRadius: "5px" }} 
            onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })}>Log Out </button></li>
              :
              <li><button style={{ backgroundColor: "#FFD700", color: "black", height: "30px",  width: "80px", borderRadius: "5px" }} 
